    ...
    <TreeItem
      ...
      label={
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Box title={`Folder Name: ${label}`} placement="top" arrow>
            <span>{label}</span>
          </Box>
          ...
          >
            <MenuList>
              <Box title="Create a new folder." arrow placement="left">
                <MenuItem onClick={handleCreateFolderOpen}>
                  <Iconify icon="mingcute:add-fill" />
                  Create Folder
                </MenuItem>
              </Box>
              <Box title="Change the folder's name." arrow placement="left">
              ...
              <Box title="Click to delete connection." arrow placement="left">
                <MenuItem
                  onClick={() => {
                    confirm.onTrue();
                    popover.onClose();

...
const _dashboardlistnames = ['a','b'];

export const _dashboardfolderlist = [
  { id: 11, name: "Home" },
  { id: 2, name: "Pabbly Connect" },
  { id: 3, name: "Main Folder" },
  { id: 4, name: "Pabbly Subscription Billin..." },
  { id: 5, name: "Pabbly Email Marketing" },  
  { id: 6, name: "Pabbly Form Builder" },
  { id: 7, name: "Pabbly Hook" },
];

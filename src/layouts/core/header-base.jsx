              ...
              <>
                <Link to="/app">
                  <Box
                    alt="logo"
                    component="img"
                    // src={`${CONFIG.site.basePath}/assets/logo/pabbly-chatflow-logo.svg`}
                    src="https://pabbly-email-verification-frontend.vercel.app/assets/icons/navbar/app/PEV_logo.svg"
                    width={120}
                    sx={{
